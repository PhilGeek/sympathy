...
% Consider a solid, rigid body, such as a stone. The stone is no mere sum of matter but is materially structured. The stone's material structure confers upon it a disposition to maintain that structure which is the categorial basis of that very disposition. In Johnston's \citeyearpar[]{Johnston:2006js} terminology, the material structure of the stone is self-maintaining.
%
% The grasping hand assimilates to the object grasped because the forces that determine the object's shape, rigidity, and solidity are sufficient to maintain the object's global shape and volume within the hands grasp. It is these self maintaining forces that resist the subject's perceptual activity, grasping, that explains why the grasping hand assimilates to the object grasped. The hand extends its activity, it tightens its grasp, until it can no more because of a countervailing force sufficient to resist its encroachment.
